namespace Stripe
{
    ...
    public class FileUploadService : StripeService
    {
        ...
        public virtual async Task<FileUpload> CreateAsync(FileUploadCreateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<FileUpload>.MapFromJson(
